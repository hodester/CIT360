...
public class View {
    ...
    public void VcreatUser() {
        ...
        Controller.creatUser(aUserName, aCreatedBy);
        System.out.println();
...
//Controller.listUser() has a problm with the return value.
//         Iterator<User> iteratedUsers = (Iterator) Controller.listUser();
// These next 2 lines should be in the Controller and NOT HERE
...
// Sucesssssss!!!! This WHILE LOOP finally works!!!!!!!
        while (iteratedUsers.hasNext()) {
            DataBaseUser user = iteratedUsers.next();
